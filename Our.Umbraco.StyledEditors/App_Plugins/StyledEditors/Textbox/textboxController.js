 ...
 */(function () {
    ...
    function styledTextboxController($scope, localizationService) {

        $scope.model.hideLabel = ($scope.model.config.hideLabel == 1);

        var vm = this;

        vm.checkCharCount = checkCharCount;
        ...
        vm.adviceMsg = 'Over by %over% characters';
        ...
        ////////////////////
        // called when the value changes, work out what 
        // message (if any) we are going to show the user
        //
    ...
    angular.module('umbraco')
        .controller('styledTextboxController', styledTextboxController);
